...
const Header: React.FC<HeaderProps> = ({ name, title, profileImage, linkedin }) => {
    ...
    <header className="header">
      <nav className="nav">
        ...
        <ul className="nav-links">
          ...
          <li><button onClick={() => scrollToSection("experience")}>Experiencia</button></li>
      ...
      <div className="hero">
        ...
        <p className="hero-eyebrow">DevOps · AWS · Cloud</p>
